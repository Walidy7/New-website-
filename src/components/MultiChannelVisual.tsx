      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight">
            ...
            <span className="text-blue-400">Every Channel Your Customers Use.</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            <div className="px-6 py-3 rounded-2xl bg-[#091226] border border-blue-900/60 text-center shadow-xl">
            ...
            <div className="h-8 w-0.5 bg-gradient-to-b from-blue-400 to-sky-400 relative my-1">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-blue-400 animate-ping" />
            </div>
            <ArrowDown className="w-4 h-4 text-blue-400 -mt-1 mb-2" />

            {/* Step 2: The Core Upper Agent Engine */}
            <div className="w-full max-w-lg p-6 rounded-2xl bg-[#070e20] border-2 border-blue-600/50 shadow-2xl shadow-black text-center relative overflow-hidden group">
              <div className="absolute -top-10 -right-10 w-28 h-28 bg-blue-600/20 rounded-full blur-2xl" />
              
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-600 text-white mb-3 shadow-lg shadow-blue-600/40">
                <Cpu className="w-6 h-6 text-white" />
              </div>
              
              <h3 className="text-xl font-black text-white tracking-wide">UPPER AGENT CORE ENGINE</h3>
              <p className="text-xs text-slate-300 mt-1 max-w-sm mx-auto">
                Trained on your business pricing, opening hours, product catalog, delivery policies &amp; FAQ
              </p>

              <div className="mt-4 pt-3 border-t border-blue-950 flex flex-wrap items-center justify-center gap-2.5 sm:gap-4 text-[11px] text-slate-300">
            ...
            <div className="h-8 w-0.5 bg-gradient-to-b from-blue-500 to-sky-400 relative my-1">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-blue-400 animate-ping" />
            </div>
            <ArrowDown className="w-4 h-4 text-blue-400 -mt-1 mb-6" />
          </div>
              ...
              return (
                <div
                  ...
                  className={`cursor-pointer p-6 rounded-2xl transition-all duration-200 border text-left ${
                    isSelected
                      ? 'bg-[#09132b] border-blue-500 shadow-xl shadow-black ring-1 ring-blue-500/40'
                      : 'bg-[#060c1c] border-blue-950 hover:border-blue-800/60 hover:bg-[#081024]'
                  }`}
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-blue-950 text-blue-300 border border-blue-900/60">
                      {chan.badge}
                    </span>
                  </div>

                  <h4 className="text-base font-bold text-white mb-1">{chan.name}</h4>
                  <p className="text-xs text-blue-300 font-medium mb-3">{chan.subtitle}</p>
                  <p className="text-xs text-slate-400 leading-relaxed mb-4">{chan.description}</p>

                  <div className="space-y-1.5 pt-3 border-t border-blue-950">
